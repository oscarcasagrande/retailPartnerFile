      ...
      <lista>
        <xsl:for-each select="catalogo/produto">
          <produto>
            ...
            <linkProduto>
              <xsl:value-of select="linkPDP"/>?utm_source=SproolOfertas&amp;utm_medium=xml&amp;utm_campaign=SproolOfertas-<xsl:value-of select="grupo"/>-<xsl:value-of select="categoria"/>-<xsl:value-of select="marca"/>-<xsl:value-of select="codModelo"/>-<xsl:value-of select="codCor"/>
            </linkProduto>
            <titulo>
