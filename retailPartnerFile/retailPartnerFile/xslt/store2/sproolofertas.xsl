      ...
      <lista>
        <xsl:for-each select="rss/channel/item">
          <produto>
            ...
            <linkProduto>
              <xsl:value-of select="link"/>?utm_source=SproolOfertas&amp;utm_medium=xml&amp;utm_campaign=SproolOfertas-<xsl:value-of select="categoria"/>-<xsl:value-of select="subgroup"/>-<xsl:value-of select="brand"/>-<xsl:value-of select="id"/>-<xsl:value-of select="color_code"/>
            </linkProduto>
            <titulo>
