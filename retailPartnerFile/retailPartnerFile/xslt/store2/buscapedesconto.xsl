    ...
    <produtos>
      <xsl:for-each select="rss/channel/item[generate-id() = generate-id(key('distinctModeloCor', substring(sku_id, 1, 8)))]">
        ...
        <PRODUTO>
          ...
          <PRECO>
            <xsl:if test="brand_code = '2239' or brand_code = '0256' or brand_code = '1349' or brand_code = '1246' or brand_code = '1357' or brand_code = '2013' or brand_code = '1363' or brand_code = '1167' or brand_code = '2171' or brand_code = '2167' or brand_code = '1791' or brand_code = '2092' or brand_code = '1524' or brand_code = '1084' or brand_code = '1239' or brand_code = '0374' or brand_code = '0197' or brand_code = '1216' or brand_code = '1352' or brand_code = '1695' or brand_code = '0158' or brand_code = '0113' or brand_code = '0321' or brand_code = '1943' or brand_code = '0363' or brand_code = '0352' or brand_code = '0008' or brand_code = '0343' or brand_code = '1275' or brand_code = '1053' or brand_code = '1998' or brand_code = '1180' or brand_code = '1228' or brand_code = '0124' or brand_code = '1184' or brand_code = '1948' or brand_code = '1295' or brand_code = '0005' or brand_code = '0091' or categoria_id = '3-0097'">
              <POR><xsl:value-of select="saleprice"/></POR>
            </xsl:if>
            <xsl:if test="brand_code != '2239' and brand_code != '0256' and brand_code != '1349' and brand_code != '1246' and brand_code != '1357' and brand_code != '2013' and brand_code != '1363' and brand_code != '1167' and brand_code != '2171' and brand_code != '2167' and brand_code != '1791' and brand_code != '2092' and brand_code != '1524' and brand_code != '1084' and brand_code != '1239' and brand_code != '0328' and brand_code != '0374' and brand_code != '0197' and brand_code != '1216' and brand_code != '1352' and brand_code != '1695' and brand_code != '0158' and brand_code != '0113' and brand_code != '0321' and brand_code != '1943' and brand_code != '0363' and brand_code != '0352' and brand_code != '0008' and brand_code != '0343' and brand_code != '1275' and brand_code != '1053' and brand_code != '1998' and brand_code != '1180' and brand_code != '1228' and brand_code != '0124' and brand_code != '0309' and brand_code != '1184' and brand_code != '1948' and brand_code != '1295' and brand_code!='0005' and brand_code != '0091' and brand_code != '0309' and brand_code != '1015' and brand_code != '0371' and brand_code != '0328' and categoria_id != '3-0097'">
          ...
          <URL>http://www.centauro.com.br/promotion2.jsp;$urlparam$811mw2QFyKi2JljHqwxfpel1WOpCWA?page=pdp&amp;productId=<xsl:value-of select="id"/>&amp;utm_source=BuscapeDesconto&amp;utm_medium=cpc&amp;utm_campaign=INST_Institucional</URL>
          ...
          <TAMANHOS>
            <xsl:for-each select="../item[id=$id]"><xsl:value-of select="size"/>;<xsl:value-of select="substring(sku_id, 9, 3)"/>;</xsl:for-each>
          </TAMANHOS>
        </PRODUTO>
      </xsl:for-each>
    </produtos>
