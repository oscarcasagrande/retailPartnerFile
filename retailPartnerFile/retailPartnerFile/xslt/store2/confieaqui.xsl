    ...
    <Loja>
      <xsl:for-each select="rss/channel/item">
        <PRODUTO>
          ...
          <link_produto>
            <xsl:value-of select="link"/>?utm_source=ConfieAqui&amp;utm_medium=xml&amp;utm_campaign=ConfieAqui-<xsl:value-of select="categoria"/>-<xsl:value-of select="subgroup"/>-<xsl:value-of select="brand"/>-<xsl:value-of select="id"/>-<xsl:value-of select="color_code"/>
          </link_produto>
          <nome_produto>
