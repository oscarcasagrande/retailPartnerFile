    ...
    <produtos>
      <xsl:for-each select="rss/channel/item">
        <PRODUTO>
          ...
          <IMAGEM>
            <xsl:value-of select="image_link"/>?utm_source=MercadoMineiro&amp;utm_medium=xml&amp;utm_campaign=MercadoMineiro-<xsl:value-of select="categoria"/>-<xsl:value-of select="subgroup"/>-<xsl:value-of select="brand"/>-<xsl:value-of select="id"/>-<xsl:value-of select="color_code"/>
          </IMAGEM>
          <DISPONIBILIDADE>
